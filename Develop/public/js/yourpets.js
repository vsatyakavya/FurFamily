...
$(document).ready(function () {
     ...
     function renderPet(props) {
       ...
       <ul>
       <div class="card text-white bg-info mb-12" style="max-width: 60rem;">
         <div class="card-body">
           ...
           <div class ="col-md-2">
           <button type="button" class="btn btn-danger btn-sm" id ="delete"><span class="fas fa-trash"></span>Delete Pet</button>
             </div>
         </div>
          </div>
           </div>
